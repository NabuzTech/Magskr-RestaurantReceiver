class GetHistoryReservationResponseModel {
  int? storeId;
  int? userId;
  int? guestCount;
  String? reservedFor;
  ...
  GetHistoryReservationResponseModel(
      {this.storeId,
        this.userId,
        this.guestCount,
        this.reservedFor,
  ...
  GetHistoryReservationResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    user = json['user'] is Map ? json['user']['id'] : json['user'];
  }
